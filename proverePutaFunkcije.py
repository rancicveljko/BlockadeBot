...
def proveriPutNagore(trenutnaPozicija: tuple) -> bool:
    if (matZidovi[2*trenutnaPozicija[0]][trenutnaPozicija[1]] == '=') or (matZidovi[2*trenutnaPozicija[0]-2][trenutnaPozicija[1]] == '='):
        return False
    else:
        return True
...
def proveriPutNadole(trenutnaPozicija: tuple) -> bool:
    if (matZidovi[2*trenutnaPozicija[0]+2][trenutnaPozicija[1]] == '=') or (matZidovi[2*trenutnaPozicija[0]+4][trenutnaPozicija[1]] == '='):
        return False
    else:
        return True
...
def proveriPutNadesno(trenutnaPozicija: tuple) -> bool:
    if (matZidovi[2*trenutnaPozicija[0]+1][trenutnaPozicija[1]+1] == chr(0x01C1)) or (matZidovi[2*trenutnaPozicija[0]+1][trenutnaPozicija[1]+2] == chr(0x01C1)):
        return False
    else:
        return True
...
def proveriPutNalevo(trenutnaPozicija: tuple) -> bool:
    if (matZidovi[2*trenutnaPozicija[0]+1][trenutnaPozicija[1]] == chr(0x01C1)) or (matZidovi[2*trenutnaPozicija[0]+1][trenutnaPozicija[1]-1] == chr(0x01C1)):
        return False
    else:
        return True
